// Vendored from Sipeed/Maixduino master
// (variants/sipeed_maix_amigo/pins_arduino.h): the framework-maixduino
// PlatformIO package (~0.3.9, what sipeed/platform-kendryte210 1.3.0 pulls)
// predates the Amigo and ships no such variant, so the stock Arduino builder
// (builder/frameworks/arduino.py) points CPPPATH at a directory that does not
// exist. app/maix/add_amigo_variant.py adds this directory instead. Delete
// both once the platform/framework packages ship the Amigo themselves.
