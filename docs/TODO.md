...
- 🚧 Event command interpreter — `Game::Interpreter` runs a solid subset (Show
  ...
  **Enemy Encounter** (10710) starts the battle path: `Game::Enemy` / `Game::Troop`
  ...
  The remaining event commands (states / Inflict Damage, Name Input, Show Battle
  Animation, vehicles, tile substitution, Change System Graphics, ...) are TODO.
  **Change Screen Transitions** (10690) records the six teleport / battle
  transition styles (save chunks 111–116; modelled for save fidelity) and **Game
  Over** (12520) returns to the title, both handled.
