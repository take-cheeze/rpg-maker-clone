- **An actor's effective max HP/MP and four combat stats (ATK/DEF/SPI/AGI)
  ...
  growing unbounded.** Ported from a reference implementation, not
  independently confirmed against genuine RPG_RT under wine: the level curve
  + Change-Parameters shadow + equipped-item bonus clamp *together* to 1..999
  (not edition-gated), and max HP/max SP clamp similarly (HP: 999 RPG2000 /
  9999 RPG2003; MP: 999 either edition). `Game::Actor#recompute_stats`
